...
const USER_CHARS_HEADER = ['UserId', 'Personagem', 'Constelacao', 'Arma', 'ArmaRefinamento', 'Build', 'AtualizadoEm'];
...
class SheetsService {
  ...
  // extras (opcional): { weaponName, weaponRefinement, build }. Quando não
  // informado (ex: o jogador só mudou a constelação num personagem que já
  // tinha build salva), o que já estava gravado é preservado.
